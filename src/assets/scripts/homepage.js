...
function init() {
	...
	// var sun = new THREE.DirectionalLight( 0xFFFFFF, 0.1 );
	...
	var sun3 = new THREE.DirectionalLight( 0xFFFFFF, 0.6 );
	sun3.position.set( 0, 1, 0 );
	scene.add( sun3 );

	hemiLight = new THREE.HemisphereLight( 0x6bc0e6, 0x6bc0e6, 0.5 );
	scene.add( hemiLight );
...
function initWater() {
	...
	heightmapVariable.material.uniforms.viscosityConstant = { value: 0.035 };
	...
	document.getElementById("c1").addEventListener('click', function() {
		...
		changeColor(0x6bc0e6);


	})
	document.getElementById("c2").addEventListener('click', function() {

		changeColor(0xd03c39);

	})
	document.getElementById("c3").addEventListener('click', function() {

		changeColor(0x4b8c4c);

	})

	function changeColor(color) {
		console.log(color);
		hemiLight.color = new THREE.Color( color );
		hemiLight.groundColor = new THREE.Color( color );
